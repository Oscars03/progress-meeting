...
export const avail = defineMessages({
  th: {
    ...
    'avail.askRange': 'ช่วงที่จะขอให้ยืนยัน',
    'avail.askRangeHint': 'เลือกเฉพาะช่วงที่จะใช้ประชุมจริง ไม่ต้องเอาทั้งบล็อก',
  ...
  en: {
    ...
    'avail.runTitle': '{when} · {state}',
    'avail.askRange': 'The span to ask about',
    'avail.askRangeHint': 'Pick the hour the meeting will actually use, not the whole block.',
