...
/**
 * The front page: the lab's mark and name, what the app is for, and the
 * sign-in form. Shown at both `/` and `/login` -- the second is where the app
 * sends anybody signed out, and where NextAuth returns a failed sign-in, and it
 * used to be the form alone on an empty screen.
 */
