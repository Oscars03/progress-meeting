    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600 mb-6">
          ...
          คุณสามารถเปิดดูรายงานสรุปทั้งหมดผ่านหน้า Sheet &ldquo;Report&rdquo; ได้โดยตรง
          ซึ่งสามารถใช้สูตรหรือ Pivot Table ในการประมวลผลข้อมูล และ Export เป็น PDF ได้ทันที
        </p>
